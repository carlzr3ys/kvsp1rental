...
export const CartItem = (props) => {
  ...
  return (
    <div className="bg-zinc-400 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between rounded-lg">
      ...
      <div className="mt-4 sm:mt-0 grid grid-cols-3">
        <button
          onClick={() => putBack()}
          className="sm:w-8 text-white text-2xl bg-red-600 rounded"
        >
          -
        </button>
        ...
        <button
          onClick={() => addMore()}
          className="sm:w-8 text-white text-2xl bg-blue-500 rounded"
        >
          +
        </button>
      </div>
